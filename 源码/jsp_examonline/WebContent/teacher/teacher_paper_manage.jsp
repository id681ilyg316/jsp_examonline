...
<body>
	...
	<sql:setDataSource var="db" driver="com.mysql.jdbc.Driver"
		url="jdbc:mysql://www.icodedock.com/examonline?useUnicode=true&serverTimezone=UTC&characterEncoding=utf-8"
		user="examonline" password="examonline" />
